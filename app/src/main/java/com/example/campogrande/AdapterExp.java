...
public class AdapterExp extends BaseExpandableListAdapter {
    ...
    public AdapterExp(Context context, List<String> listHeader, HashMap<String, List<String>> hashMapList) {
    ...
    public View getGroupView(int i, boolean b, View view, ViewGroup viewGroup) {
        ...
        if (view == null) {
            ...
            view = inflater.inflate(R.layout.listview_exp, null);
        }
        TextView lblListHeader = view.findViewById(R.id.headers);
